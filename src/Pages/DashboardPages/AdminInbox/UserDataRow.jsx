...
const UserDataRow = ({ inboxUser, refetch, serialNo }) => {
  ...
  return (
    <>
      <tr className="border-b transition text-base duration-300 ease-in-out hover:bg-gray-500 hover:text-white hover:shadow-2xl dark:border-neutral-500 dark:hover:bg-neutral-600">
