...
const SavedHistory = () => {
    return (
        <div className="container mx-auto flex justify-center items-center gap-20 my-20">
            <div className="flex flex-col items-center gap-2">
                <div className="w-20 h-20 flex justify-center items-center border-2 rounded-full">
