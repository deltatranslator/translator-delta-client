    ...
    return (
        <div>
            <div className="mt-5">
                ...
                <p className="text-center font-medium mt-2"> Our team thrives on tackling challenges head-on and finding innovative solutions.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-x-16 gap-y-5  mt-16 mb-8">
               <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
                  ...
                  <div className=" items-center text-center">
                    <h2 className="font-semibold text-xl my-1 mt-3">Fazle Rabby</h2>
                ...
                <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
                  ...
                  <div className=" items-center text-center">
                    ...
                    <h2 className="text-[#00ABE4] my-1">FrontEnd Developer</h2>
                    <h2>Full Stack Developer with a Focus <br /> on MERN || Expert in Front-end Technologies at all . </h2>
                   <div className="flex justify-center gap-3 mt-6">
                ...
                <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
                  ...
                  <div className=" items-center text-center">
                    ...
                    <h2 className="text-[#00ABE4] my-1">FrontEnd Developer </h2>
                        <h2>Passionate MERN Stack Developer  <br /> eager to contribute and showcase dedication.</h2>
                   <div className="flex justify-center gap-3 mt-6">
                ...
                <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
                  ...
                  <div className=" items-center text-center">
                    <h2 className="font-semibold text-xl my-1 mt-3">Md Morshed Alam</h2>
                    <h2 className="text-[#00ABE4] my-1">FrontEnd Developer</h2>
                ...
                <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
                  ...
                  <div className=" items-center text-center">
                    <h2 className="font-semibold text-xl my-1 mt-3">Md. Nafis Ikbal Bhuiyan</h2>
                    <h2 className="text-[#00ABE4] my-1">FrontEnd Developer</h2>
                    <h2> 
