    ...
    <div>
      <div className="mt-5">
        ...
        <p className="text-center font-medium mt-2">
          {" "}
          Our team thrives on tackling challenges head-on and finding innovative
          solutions.
        </p>
      </div>
      <div className="flex justify-center">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-x-16 gap-y-5  mt-16 mb-8">
          <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
            <figure className="">
              <img
                src="https://i.ibb.co/Q6dKK4N/1709542185354.jpg"
                alt="Shoes"
                className="rounded-full w-28 h-28"
              />
            </figure>
            <div className=" items-center text-center">
              <h2 className="font-semibold text-xl my-1 mt-3">
                Md Fajle Rabby
              </h2>
          ...
          <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
            <figure className="">
              <img
                src="https://i.ibb.co/0n4j7Vz/1698063591767.jpg"
                alt="Shoes"
                className="rounded-full w-28 h-28"
              />
            </figure>
            <div className=" items-center text-center">
              <h2 className="font-semibold text-xl mt-3 my-1">Naym Hossen</h2>
              <h2 className="text-[#00ABE4] my-1">Front End Developer</h2>
              <h2>
                Full Stack Developer with a Focus <br /> on MERN || Expert in
                Front-end Technologies at all .{" "}
              </h2>
              <div className="flex justify-center gap-3 mt-6">
          ...
          <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
            <figure className="">
              <img
                src="https://i.ibb.co/k9v24yg/26358891.jpg"
                alt="Shoes"
                className="rounded-full w-28 h-28"
              />
            </figure>
            <div className=" items-center text-center">
              <h2 className="font-semibold text-xl my-1 mt-3">Golam Kibria</h2>
              <h2 className="text-[#00ABE4] my-1">Front End Developer </h2>
              <h2>
                Passionate MERN Stack Developer <br /> eager to contribute and
                showcase dedication.
              </h2>
              <div className="flex justify-center gap-3 mt-6">
          ...
          <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
            <figure className="">
              <img
                src="https://i.ibb.co/CvRJHBg/138320069.jpg"
                alt="Shoes"
                className="rounded-full w-28 h-28"
              />
            </figure>
            <div className=" items-center text-center">
              <h2 className="font-semibold text-xl my-1 mt-3">Mahedi Hasan</h2>
              <h2 className="text-[#00ABE4] my-1">Front End Developer</h2>
              <h2>
                {" "}
                Showcase the ability to adjust to changes and challenges during
          ...
          <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
            <figure className="">
              <img
                src="https://i.ibb.co/PMQzgQt/138389296.png"
                alt="Shoes"
                className="rounded-full w-28 h-28"
              />
            </figure>
          ...
          <div className="card w-72 mx-auto md:w-80 md:h-96 py-8 bg-base-100 shadow-md shadow-blue-400">
            <figure className="">
              <img
                src="https://i.ibb.co/MsgP3nY/Whats-App-Image-2024-02-10-at-17-40-10.jpg"
                alt="Shoes"
                className="rounded-full w-28 h-28"
              />
            </figure>
            <div className=" items-center text-center">
              ...
              <h2 className="text-[#00ABE4] my-1">Front End Developer</h2>
              <h2>
                Developer with a passion for innovation, and continuous learning
