      ...
      <div className=" grid md:grid-cols-2 lg:grid-cols-3 gap-10  mt-20 mb-8">
        <div className="card w-80 mx-auto md:w-96 md:h-80 py-8 bg-base-100 shadow-md shadow-blue-400">
          ...
          <div className=" items-center text-center">
            <h2 className="font-semibold text-xl my-1">Md Fajle Rabby</h2>
        ...
        <div className="card w-80 mx-auto md:w-96 py-8 md:h-80 bg-base-100 shadow-md shadow-blue-400">
          ...
          <div className=" items-center text-center">
            ...
            <h2>
              Full Stack Developer with a Focus on MERN || Expert in Front-end
              Technologies
            </h2>
            <div className="flex justify-center gap-3 mt-3">
        ...
        <div className="card w-80 mx-auto md:w-96 md:h-80 py-8 bg-base-100 shadow-md shadow-blue-400">
          ...
          <div className=" items-center text-center">
            ...
            <h2 className="text-[#00ABE4] my-1">Frontend Developer </h2>
            <h2>
              Passionate MERN Stack Developer eager to contribute and showcase
              dedication.
            </h2>
            <div className="flex justify-center gap-3 mt-3">
