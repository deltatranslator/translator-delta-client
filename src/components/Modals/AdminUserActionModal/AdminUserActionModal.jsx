...
const AdminUserActionModal = ({ user, open, close }) => {
  ...
  const handleUpdateUserInfo = async () => {
    ...
    axiosSecure
      .patch(`/admin-user-update/${user?.email}`, userInfo)
      .then((res) => {
      ...
      <div className="fixed w-[300px] md:w-[700px] top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] bg-white px-4 md:px-20 py-8 md:py-14 z-50 rounded-md">
        <div className="flex">
          ...
          <div className="flex items-center justify-end relative">
            <div className="absolute cursor-pointer w-12 h-12 hover:bg-blue-300 hover:bg-opacity-80 flex items-center justify-center rounded-full transition ease-in-out duration-500 -mt-10">
        ...
        <div className="p-2 flex flex-col justify-center items-start">
          <div className="w-full flex justify-center">
            <div className="border-l-2 pl-8 md:pl-12 border-blue-300 w-full p-2">
              <div className="flex gap-4 mx-8 my-4">
                <h1 className="font-medium">Current Role</h1>
              ...
              <div className="my-6 flex items-center gap-8">
                ...
                <div className="footer pr-4 flex justify-start">
                  ...
                  <button
                    ...
                    className={`btn btn-ghost w-1/2 flex justify-center items-center ${
                      !user.banState
                        ? "bg-red-500 text-white hover:bg-red-600"
                        : "bg-gray-300 hover:bg-gray-400 text-black"
                    }  font-medium text-[17px] tracking-wider`}
                  >
                    {user.banState ? "Unban" : "Ban"}
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="w-full pl-8 pr-4 flex justify-around -mb-2 mt-12 gap-8">
            <div className="w-1/2 flex justify-end items-center pr-4">
              <button
                ...
                className="btn btn-ghost flex justify-center items-center hover:bg-blue-300 w-32"
              >
                Save
              </button>
            </div>
            <div className="w-1/2 flex justify-start items-center">
              <button
                onClick={close}
                className="btn btn-ghost flex justify-center items-center w-32"
              >
                Cancel
              </button>
            </div>
