      ...
      <div className="hero min-h-screen ">
        <div className="hero-content flex-col lg:flex-row">
          <div className="text-center lg:text-left text-yellow-500 ">
            ...
            <p className="py-6 text-white w-11/12">
          ...
          <div className="card shrink-0 w-full max-w-sm lg:max-w-lg">
            <h1 className="text-5xl font-bold text-yellow-600 ml-10">
              Sign UP
            </h1>
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-yellow-500 font-semibold">
                    Name
                  </span>
                </label>
                <input
                  ...
                  type="text"
                  placeholder="email"
                  className="input input-bordered border-yellow-600  "
                  required
                />
              </div>
              {errors.name && (
              ...
              <div className="form-control mt-6">
                <button
                  type="submit"
                  className="btn bg-yellow-600 hover:bg-yellow-800 text-white font-semibold"
                >
                  Sign UP
                </button>
              </div>
